...
public interface GenericDAO<T> {
    ...
    String TUTORED = "CREATE TABLE tutoreds(id INTEGER PRIMARY KEY, name TEXT, surname TEXT, phoneNumber TEXT, carrer_id INTEGER, FOREIGN KEY(carrer_id) REFERENCES careers(id));";
