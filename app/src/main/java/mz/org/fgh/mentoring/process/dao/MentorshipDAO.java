...
public interface MentorshipDAO extends GenericDAO<Mentorship> {
    ...
    class QUERY {
        public static final String findAll = "SELECT m.id, m.uuid, m.form_uuid, m.tutored_uuid, m.health_facility_uuid, f.name as form_name, t.name as tutored_name, t.surname as tutored_surname, hf.health_facility as health_facility, m.start_date, m.end_date, m.created_at " +
                "FROM " + TABLE_NAME + " m " +
